...
#define kpath @"http://news-at.zhihu.com/api/4/theme/4"
#define kReFresh @"http://news-at.zhihu.com/api/4/theme/4/before/"
@interface dsignViewController ()

@end

@implementation dsignViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title=@"设计日报";
